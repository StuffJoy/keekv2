...
<body>
	<div id="parent_container">
		...
		<div id="contactUs_container" style="padding-left: 40px;">
			...
			<form action="../DatabaseConnections/AdminConnections.php" method="post" class="formular">
				<label for="lblEmail" style="width:15%;">Email Address: </label>
				<input type="text" name="txtEmail" /><br/>
				
				<label for="lblSecurityQuestion" style="width:15%;">Security Question:</label>
				<?php
				...
				<label for="lblSecurityAnswer" style="width:15%;">Security Answer: </label>
				<input type="text" name="txtSecurityAnswer" class="validate[required]" /><br/>
				
				<input type="submit" name="btnPasswordReset" value="Submit" />
			</form>
		</div>
	</div>
	<?php
