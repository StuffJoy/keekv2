...
<head>
	...
	<script>
		jQuery(document).ready(function(){
			...
			jQuery("#adminEmail").validationEngine('attach');
		});
  	</script>
</head>
...
<body>
		...
		<h1>Admin Email</h1>
			<form action="SendAdminEmail.php" method="post" id="adminEmail" class="formular">
				
				Enter Email of Selected: <input type="email" name="txtAdminEmail"  class="validate[required, custom[email], custom[gmailOnly]] text-input"/>
				
				<input type="submit" name="btnSubmit" value="Send Email" />
			</form>
		</div>
		</div>
		</div>
